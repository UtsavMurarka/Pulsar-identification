...
for i in range(len(test)):
    if y_pred[i]==y_test[i]:
        score=score+1
score=score*100/len(test)
print("\n\n##### sigmoid Kernel with class_weight = 'balanced' ######\n\n")
print("Accuracy = " + "%.2f" % score + "%")
runtime = t2 - t1
print("Runtime: %s" % (str(runtime)))
...
clf = SVC(kernel='sigmoid', class_weight={1:1})
